...
/*--->Super calling statement is used to calling one class
      Constructor inside another class constructor
  --->It should be the first statement inside constructor
  --->Only one super calling statement will be allowed
 */
class Vehicle
{
	//Declaring variables
